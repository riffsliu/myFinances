...
public class UsuarioDAO extends BaseDAO {
	...
	public UsuarioVO buscarUsuario(String emailUsuario) {
		

		StringBuilder sql = new StringBuilder();
		
		sql.append("SELECT usuarioVO FROM UsuarioVO usuarioVO ");
		sql.append("WHERE usuarioVO.emailUsuario = :pEmailUsuario ");
		
		Query query = getEntityManager().createQuery(sql.toString());
		
		query.setParameter("pEmailUsuario", emailUsuario);
