 ...
 */
package org.primefaces.california.component.menu;
...
@ListenerFor(sourceClass = CaliforniaMenu.class, systemEventClass = PostAddToViewEvent.class)
public class CaliforniaMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {

    public static final String COMPONENT_TYPE = "org.primefaces.component.CaliforniaMenu";
    public static final String COMPONENT_FAMILY = "org.primefaces.component";
    private static final String DEFAULT_RENDERER = "org.primefaces.component.CaliforniaMenuRenderer";
